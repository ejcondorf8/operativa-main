...
class GptAnaliser:
    ...
    def interpretar_sensibilidad(resultados):
        ...
        prompt = (
            "Se presenta un problema de programación lineal resuelto. Por favor, analiza los resultados obtenidos, "
            ...
            "Por favor, proporciona un análisis de sensibilidad considerando los siguientes aspectos:\n"
            "1. Cambios en los coeficientes de la función objetivo: Por ejemplo, si el coeficiente del término 'x' aumenta de 3 a 5, "
